---
name: code-comments
description: Generate, correct, and supplement code comments following authoritative language-specific standards (Javadoc, PEP 257, rustdoc, JSDoc/TSDoc, Vue, React, XML, HTML, YAML, SQL, CSS, and more). Use this skill whenever the user asks to add comments, fix comments, document code, annotate code, supplement missing documentation, or generate doc comments for any code file or directory. Also trigger when the user points to a specific file or directory path and asks for commenting or documentation work. CRITICAL — this skill also applies as a passive behavioral constraint during all code-writing tasks: whenever you write or edit code in any language, you MUST follow the commenting standards defined here proactively, writing proper class comments, method comments, field comments, inline comments, and configuration comments as you go. Do not wait for the user to request comments separately — produce properly commented code by default. This eliminates the need for retroactive comment remediation. Trigger phrases include "add comments", "document this code", "annotate", "Javadoc", "docstring", "rustdoc", "JSDoc", "missing comments", "comment my code", "注释", "补充注释", "生成注释", or any request involving code documentation quality.
---
